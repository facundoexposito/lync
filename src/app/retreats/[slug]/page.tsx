  ...
  return (
    <>
            ...
            <div className="flex-1">
              <ScrollReveal>
                ...
                <p className="mb-4 text-lg leading-relaxed text-muted">
                  This is not a holiday. It is not a yoga retreat. It is not a
                  break from your life.
                </p>
                <p className="mb-4 leading-relaxed text-muted">
                  It is a return. To yourself. To your heart. To the quiet,
                  certain knowing inside you that has always understood your
                  truest purpose — if only you would give it the space to
                  speak.
                </p>
      ...
      <section className="bg-cream py-16 md:py-24">
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <ScrollReveal>
            {/* Mobile: simple 2x2 grid · Desktop: bento layout */}
        ...
        <div className="mx-auto max-w-3xl px-5 sm:px-8">
          <ScrollReveal>
            ...
            <p className="mb-12 text-center text-sm text-muted">
              No two days are exactly the same — but every single one belongs
              entirely to you.
            </p>
          </ScrollReveal>
        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <ScrollReveal>
            ...
            <p className="mx-auto mb-12 max-w-2xl text-center text-sm leading-relaxed text-muted">
              This outline reflects the heart and intention of each day.
              Specific workshops and timings may shift — what will never
              change is the depth, the care, and the transformation.
            </p>
          </ScrollReveal>

          {/* Row 1: Days 1-3 */}
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {retreat.itinerary.slice(0, 3).map((day, i) => (
          ...
          <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {retreat.itinerary.slice(3, 6).map((day, i) => (
              <ScrollReveal key={day.day} delay={(i + 3) * 0.06}>
                <div className="flex h-full flex-col rounded-2xl border border-border bg-white p-6 shadow-sm transition-shadow hover:border-lync/20 hover:shadow-md">
                  <div className="mb-3 flex items-center gap-2.5">
                    <span className="text-2xl">{day.emoji}</span>
                    <span className="text-xs font-bold uppercase tracking-widest text-lync">
          ...
          {/* Row 3: Day 7 */}
          {retreat.itinerary.length > 6 && (
            <div className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <ScrollReveal delay={6 * 0.06}>
                <div className="flex h-full flex-col rounded-2xl border border-border bg-white p-6 shadow-sm transition-shadow hover:border-lync/20 hover:shadow-md">
                  <div className="mb-3 flex items-center gap-2.5">
                    <span className="text-2xl">{retreat.itinerary[6].emoji}</span>
                    <span className="text-xs font-bold uppercase tracking-widest text-lync">
                      Day {retreat.itinerary[6].day}
                    </span>
                  </div>
                  <h3 className="mb-3 font-display text-lg font-semibold uppercase tracking-normal">
                    {retreat.itinerary[6].title}
                  </h3>
                  <ul className="space-y-2">
                    {retreat.itinerary[6].highlights.map((item) => (
                      <li key={item} className="flex items-start gap-2 text-sm leading-relaxed text-muted">
                        <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-lync/40" />
                        {item}
                      </li>
